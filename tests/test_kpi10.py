"""
Prueba para inspeccionar el resultado del KPI 10
(nivel de inventario proyectado).
Ejecutar con: python tests/test_kpi10_nivel_inventario.py
"""
...
# =====================================================
    ...
    print("Calculando KPI 10...\n")
    resultado = app.analytics_model.calcular_nivel_inventario_proyectado()

    # =====================================================
    # 1. RESUMEN GENERAL
    # =====================================================
    print("=" * 60)
    print("RESUMEN KPI 10 - NIVEL DE INVENTARIO PROYECTADO")
    print("=" * 60)
    print(f"Cantidad en riesgo de desabastecimiento : {resultado['cantidad_riesgo_desabastecimiento']}")
    ...
    # =====================================================
    # 3. CONTEO POR ESTADO (Suficiente/Justo/Riesgo/Sin datos)
    # =====================================================
    print("\n" + "=" * 60)
    ...
    # =====================================================
    # 4. LOS 10 CASOS MÁS CRÍTICOS (menor nivel proyectado)
    # =====================================================
    print("\n" + "=" * 60)
    print("TOP 10 - MENOR NIVEL DE INVENTARIO PROYECTADO")
    print("=" * 60)
